...
const partners = [
  ...
  { name: 'Jinko Solar', label: 'JinKo Solar Brand', logo: '/images/brands/jinkosolar.png', image: '/images/projects/solution-1.jpg' },
    ...
    <section className="py-20 md:py-28 bg-gray-50">
      <div className="container mx-auto px-4">
        ...
        <div className="flex flex-col md:flex-row gap-8 items-start max-w-6xl mx-auto">
          {/* Left: brand list */}
          <div className="flex flex-col justify-between w-full md:w-[520px] md:h-[380px] shrink-0">
            {partners.map((p, i) => (
              <button
                key={p.name}
                onClick={() => setActive(i)}
